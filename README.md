...
- **Ton champion, le 128ᵉ joueur** 🎾 : en début de saison tu crées ton propre joueur — prénom, nom, club, nationalité, classement (de 40 à -15) — et tu répartis toi-même ses points entre les 10 compétences. Son total est **la moyenne du plateau** — 70 points en mode légendes, ~87 en mode ATP, la moyenne réelle en CSV — ni plus ni moins : ton avantage, c'est le **profil sur mesure** (et les +3 points par saison en mode carrière). Il est automatiquement l'un de tes 5 favoris, et le bookmaker calcule sa cote avec les compétences que tu lui as données — à toi de décider si tu mises sur lui.
- **Cash-out & paris de tournoi** 🎰 : à tout moment, revends un pari de saison au bookmaker à **80 % de sa juste valeur** (gains acquis + espérance sur les tournois restants). Le cash alimente les **paris de tournoi** : avant chaque épreuve, un marché coté en simulant le tableau réellement tiré propose le vainqueur du tournoi (favoris + un outsider), le parcours de ton champion (« passe le 1er tour » → « gagne le tournoi »), des défis fun (« la finale ira au set décisif », « un 6-0 sera infligé », « la tête d'affiche tombera avant les quarts »…), des paris **plus/moins** (nombre de jeux de la finale, % de jeux de service gagnés sur l'ensemble du tournoi) et le pari sur **le score de set le plus fréquent** du tournoi (6-0 → 7-6, les ex aequo comptent gagnants). Le panneau du marché liste en détail chaque pari déjà placé (mise, cote, gain potentiel) et, en Masters 1000, **les 8 repêchés des qualifications**. Le marché ferme au premier match, les gains tombent au récap — où chaque pari affiche **le fait réel qui justifie le paiement ou non** (« Finale jouée en 24 jeux », « Vainqueur réel : … », « 2 sets 6-0 infligés »…).
- **Mode Hot Points** 🔥 : sur les matchs de **ton champion**, un bouton « 🔥 Hot points » lance un mode turbo qui simule le match point par point et s'arrête sur chaque **point chaud** : balles de break (dans les deux sens), balles de set, balles de match et **tous les points de tie-break**. À chaque arrêt, c'est toi qui choisis le coup — au service : **Ace** (Service), **Lime** (Endurance), **Agression** (Force) ou **Amortie** (Adresse) ; en retour : Lime, Agression ou Amortie. Le **Mental** booste tous tes hot points… mais gare à la routine : répéter le même coup rend prévisible, l'adversaire s'en souvient et prend l'avantage — le tout modulé par la **Tactique** des deux joueurs. La carte de ton champion affiche une tuile « 🔥 Hot points gagnés » (cumulée sur la carrière).
- **Tes 5 favoris** ⭐ : en début de saison tu choisis les 5 joueurs que tu **suis** (ton champion en fait forcément partie) : leurs matchs se jouent à la main — « Simuler le tournoi » s'arrête sur chacun — et eux seuls peuvent être dopés. Les favoris sont **indépendants des paris** : tu n'es pas obligé de miser sur eux.
- **Les paris de saison** 💶 : un **capital** (10 000 € au départ de la carrière) à miser **librement** : 0 à 5 paris, sur n'importe quel joueur — tes favoris, ton champion, un outsider inconnu, ou personne du tout. Gain d'un pari = mise × prize money réel / prize money attendu, encaissé en fin de saison. Les « prize money attendus » (les cotes) sont calibrés par le bookmaker en simulant 120 saisons complètes : l'espérance est neutre quelle que soit la répartition — parier un cador rapporte peu par euro, un outsider peut tout multiplier. Ce qui n'est pas misé reste en **cash**.
- **Mon portefeuille** 💼 (💶 dans la barre) : l'écran économique distingue clairement le **cash** (argent réel, disponible tout de suite pour les paris de tournoi et le dopage), la **valeur virtuelle des paris de saison** (elle bouge à chaque tournoi, encaissée en fin de saison ou via cash-out) et les **mises de tournoi en attente** — avec une barre de composition du patrimoine, le capital de départ et l'écart vs le rythme attendu.
- **Bilan financier & impôt** 🧾 : en fin de saison, le bilan tombe — capital de départ vs valeur finale. Un **gain global est imposé à 30 %** ; une perte n'est pas taxée. En mode carrière, **rien n'est offert** : tu repars la saison suivante avec ton capital net d'impôt, ni plus ni moins. Flamber ou capitaliser, c'est toute ta carrière qui se joue.
...
- **Dopage** 💉 : avant chaque tournoi, tu peux booster **un de tes 5 favoris** (3 doses par saison, **1 000 € la dose, payée en cash** — pas de cash, pas de dopage). Le joueur dopé reçoit un vrai coup de pouce — avantageux mais pas décisif — et ne ressent aucune fatigue… mais il a **5 % de risque d'être contrôlé positif** à l'issue du tournoi : 3 mois de suspension (il manque les tournois suivants, remplacé par des exemptions dans les tableaux). Le bookmaker, lui, n'en sait rien — c'est ton avantage.
